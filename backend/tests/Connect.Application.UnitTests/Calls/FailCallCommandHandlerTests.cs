...
public class FailCallCommandHandlerTests
{
    ...
    public FailCallCommandHandlerTests()
    {
        ...
        _handler = new FailCallCommandHandler(
    ...
    public async Task Handle_CallNotFound_ThrowsNotFoundException()
    {
        ...
        var command = new FailCallCommand(_callId);
    ...
    [Fact]
    public async Task Handle_ValidParticipant_FailsCallSetsReasonAndResetsPresence()
    {
        ...
        var command = new FailCallCommand(_callId, MissedReason.ConnectionFailed);
